import{j as e}from"./index-xxW3EWhZ.js";function g({children:o,title:r,subtitle:a,className:c="",padding:t="md",variant:d="default",accentColor:n="blue"}){const s={none:"",sm:"p-4",md:"p-6",lg:"p-8"},l={blue:"from-accent-blue/20 to-transparent",purple:"from-accent-purple/20 to-transparent",pink:"from-accent-pink/20 to-transparent",cyan:"from-accent-cyan/20 to-transparent",emerald:"from-accent-emerald/20 to-transparent",orange:"from-accent-orange/20 to-transparent"},m={blue:"border-accent-blue/30",purple:"border-accent-purple/30",pink:"border-accent-pink/30",cyan:"border-accent-cyan/30",emerald:"border-accent-emerald/30",orange:"border-accent-orange/30"},i=`
